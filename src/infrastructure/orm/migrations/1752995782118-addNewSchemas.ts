...
export class AddNewSchemas1752995782118 implements MigrationInterface {
  name = 'AddNewSchemas1752995782118'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_697a01994e9034f887e89242156"`
    )
    await queryRunner.query(
      `CREATE TABLE "category" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "event_id" uuid, "projectsId" uuid, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "project_member_attendance" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" character varying NOT NULL DEFAULT 'pendiente', "comment" text, "timestamp" TIMESTAMP NOT NULL, "sessionId" uuid, "projectMemberId" uuid, CONSTRAINT "PK_ef41a6e5c9080539a94d3c3f1fb" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "project_category" ("project_id" uuid NOT NULL, "category_id" uuid NOT NULL, CONSTRAINT "PK_41532c841fdd37fa75062bfce8b" PRIMARY KEY ("project_id", "category_id"))`
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_99d66734488559ed1c616e737c" ON "project_category" ("project_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_0a5cd888a52a875ae6a14e280a" ON "project_category" ("category_id") `
    )
    await queryRunner.query(
      `ALTER TABLE "project" DROP CONSTRAINT "PK_8505f3977d7839dd709ff79f9d7"`
    )
    await queryRunner.query(`ALTER TABLE "project" DROP COLUMN "uid"`)
    ...
    await queryRunner.query(`ALTER TABLE "project" DROP COLUMN "averageScore"`)
    await queryRunner.query(
      `ALTER TABLE "role" DROP CONSTRAINT "PK_914a4da5bf2e66f917f4737908a"`
    )
    await queryRunner.query(`ALTER TABLE "role" DROP COLUMN "uid"`)
    await queryRunner.query(`ALTER TABLE "role" DROP COLUMN "roleName"`)
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "PK_df955cae05f17b2bcf5045cc021"`
    )
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "uid"`)
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "roleUid"`)
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "project" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`
    )
    await queryRunner.query(
      `ALTER TABLE "project" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`
    )
    await queryRunner.query(`ALTER TABLE "project" ADD "event_id" uuid`)
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "role" ADD "description" text NOT NULL`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "category" ADD CONSTRAINT "FK_b8a27291c73e83a4df50150371f" FOREIGN KEY ("projectsId") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "pending_client_staff" ADD CONSTRAINT "FK_1af23403e4e5eaeb9b76b5646e5" FOREIGN KEY ("clientId") REFERENCES "client"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "pending_client_staff" ADD CONSTRAINT "FK_682f5deadc7b0f5fe7f7de47e98" FOREIGN KEY ("roleId") REFERENCES "role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "project_category" ADD CONSTRAINT "FK_99d66734488559ed1c616e737c7" FOREIGN KEY ("project_id") REFERENCES "project"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    )
    await queryRunner.query(
      `ALTER TABLE "project_category" ADD CONSTRAINT "FK_0a5cd888a52a875ae6a14e280a8" FOREIGN KEY ("category_id") REFERENCES "category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "project_category" DROP CONSTRAINT "FK_0a5cd888a52a875ae6a14e280a8"`
    )
    await queryRunner.query(
      `ALTER TABLE "project_category" DROP CONSTRAINT "FK_99d66734488559ed1c616e737c7"`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "category" DROP CONSTRAINT "FK_b8a27291c73e83a4df50150371f"`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "rut"`)
    await queryRunner.query(
      `ALTER TABLE "user" ADD "rut" character varying NOT NULL`
    )
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "UQ_9f839e522b3b8c8c8223cde81db" UNIQUE ("rut")`
    )
    ...
    await queryRunner.query(`ALTER TABLE "project" DROP COLUMN "event_id"`)
    ...
    await queryRunner.query(`ALTER TABLE "user" ADD "roleUid" uuid`)
    await queryRunner.query(
      `ALTER TABLE "user" ADD "uid" uuid NOT NULL DEFAULT uuid_generate_v4()`
    )
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "PK_df955cae05f17b2bcf5045cc021" PRIMARY KEY ("uid")`
    )
    await queryRunner.query(
      `ALTER TABLE "role" ADD "roleName" character varying NOT NULL`
    )
    await queryRunner.query(
      `ALTER TABLE "role" ADD "uid" uuid NOT NULL DEFAULT uuid_generate_v4()`
    )
    await queryRunner.query(
      `ALTER TABLE "role" ADD CONSTRAINT "PK_914a4da5bf2e66f917f4737908a" PRIMARY KEY ("uid")`
    )
    await queryRunner.query(
      `ALTER TABLE "project" ADD "averageScore" double precision NOT NULL DEFAULT '0'`
    )
    await queryRunner.query(
      `ALTER TABLE "project" ADD "category" character varying NOT NULL`
    )
    await queryRunner.query(
      `ALTER TABLE "project" ADD "projectName" character varying NOT NULL`
    )
    await queryRunner.query(
      `ALTER TABLE "project" ADD "uid" uuid NOT NULL DEFAULT uuid_generate_v4()`
    )
    await queryRunner.query(
      `ALTER TABLE "project" ADD CONSTRAINT "PK_8505f3977d7839dd709ff79f9d7" PRIMARY KEY ("uid")`
    )
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0a5cd888a52a875ae6a14e280a"`
    )
    await queryRunner.query(
      `DROP INDEX "public"."IDX_99d66734488559ed1c616e737c"`
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_697a01994e9034f887e89242156" FOREIGN KEY ("roleUid") REFERENCES "role"("uid") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
  }
}
